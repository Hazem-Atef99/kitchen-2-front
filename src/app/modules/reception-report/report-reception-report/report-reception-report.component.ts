...
@Component({
  selector: 'app-report-reception-report',
  templateUrl: './report-reception-report.component.html',
  styleUrls: ['./report-reception-report.component.scss']
})
export class ReportReceptionReportComponent {
  base64String: string = '';
  clientFileId: any;
  zoom = 1.0;
  pdfDocument: any;
  ...
  constructor(
    private _recptionReportService:ReceptionReportService,
  ...
  getQuatationReport() {
    this.Isloading = true
    this._recptionReportService.GetReportReceptionReport(this.clientFileId).subscribe({
      next:
        (res: any) => {
