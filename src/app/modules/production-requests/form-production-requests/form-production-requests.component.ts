...
export class FormProductionRequestsComponent {
  ...
  constructor(
    ...
    this.ListOfItems.forEach((ele: any, index: number) => {
      // ele.id == 1 ?  this.ProductionRequestsFormGroup().addControl('categoryId', new FormControl(null)) : console.log(index);
  ...
  get items2Form() {
    return this.AddProductionRequestsForm.controls["items2"]
  }
