...
@Component({
  selector: 'app-report-qutation',
  templateUrl: './report-qutation.component.html',
  styleUrls: ['./report-qutation.component.scss']
})
export class ReportQutationComponent implements OnInit {
  base64String: string = '';
  clientFileId: any;
  zoom = 1.0;
  pdfDocument: any;
